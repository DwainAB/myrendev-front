...
import { StyledNavigationBar } from "./styles/NavigationBar.styled";
...
function NavigationBar() {
  ...
  return navigationState.isDisplayed ? (
    <StyledNavigationBar activepage={navigationState.navigationPage}>
        ...
        <ul>
          <Flex
            onClick={() => (
              ...
              setCustomerState((prev) => ({ ...prev, clientDetails: null })),
              navigate("/")
            )}
          >
            <li>
